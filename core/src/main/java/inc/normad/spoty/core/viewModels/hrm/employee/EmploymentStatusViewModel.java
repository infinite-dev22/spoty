...
import inc.normad.spoty.network_bridge.dtos.hrm.employee.EmploymentStatus;
import inc.normad.spoty.network_bridge.models.FindModel;
import inc.normad.spoty.network_bridge.models.SearchModel;
import inc.normad.spoty.network_bridge.repositories.implementations.EmploymentStatusesRepositoryImpl;
...
public class EmploymentStatusViewModel {
    ...
    public static ObservableList<EmploymentStatus> getEmploymentStatuss() {
        return employmentStatuses.get();
    }

    public static void setEmploymentStatuss(ObservableList<EmploymentStatus> employmentStatuses) {
    ...
    public static void getAllEmploymentStatuss(
