...
import inc.nomard.spoty.core.views.forms.ServiceFormController;
import inc.nomard.spoty.network_bridge.dtos.Service;
...
public class ServiceController implements Initializable {
    ...
    private MFXContextMenu showContextMenu(MFXTableRow<Service> obj) {
        ...
        edit.setOnAction(
                e -> {
                    SpotyThreader.spotyThreadPool(() -> {
                        try {
                            ServiceViewModel.getItem(obj.getData().getId(), this::onAction, this::onSuccess, this::onFailed);
                        } catch (Exception ex) {
                            throw new RuntimeException(ex);
                        }
                    });
    ...
    private void setIcons() {
        ...
        refreshIcon.setOnMouseClicked(mouseEvent -> ServiceViewModel.getAllServices(this::onAction, this::onSuccess, this::onFailed));
    }
}
