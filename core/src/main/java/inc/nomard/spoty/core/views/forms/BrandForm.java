...
@Log
public class BrandForm extends BorderPane {
    ...
    public BrandForm(ModalPane modalPane) {
                ...
                (event) -> {
                    ...
                    if (nameConstraints.isEmpty()) {
                        ...
                        if (BrandViewModel.getId() > 0) {
                            BrandViewModel.updateItem(this::onSuccess, SpotyUtils::successMessage, this::errorMessage);
                        } else {
                            BrandViewModel.saveBrand(this::onSuccess, SpotyUtils::successMessage, this::errorMessage);
                        }
                    }
                });
    }
