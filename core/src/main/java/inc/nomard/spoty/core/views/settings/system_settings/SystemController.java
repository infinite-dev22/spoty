...
public class SystemController implements Initializable {
    ...
    private void initGUI() throws Exception {
        SpotyThreader.spotyThreadPool(() -> {
            try {
                BranchViewModel.getItem(preferences.getLong("default_branch", 1), this::onAction, this::onSuccess, this::onFailed);
                CurrencyViewModel.getItem(preferences.getLong("default_currency", 1), this::onAction, this::onSuccess, this::onFailed);
            } catch (Exception e) {
                SpotyLogger.writeToFile(e, this.getClass());
            }
        });
...
//        refreshIcon.setOnMouseClicked(mouseEvent -> SystemViewModel.getAllSystems(this::onAction, this::onSuccess, this::onFailed));
    }
}
