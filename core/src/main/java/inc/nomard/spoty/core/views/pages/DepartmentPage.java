...
public class DepartmentPage extends OutlinePage {
    ...
    public DepartmentPage() {
        ...
        DepartmentViewModel.getAllDepartments(this::onDataInitializationSuccess, this::errorMessage);
    }
    ...
    private MFXContextMenu showContextMenu(TableRow<Department> obj) {
