...
public class SalaryAdvancesController implements Initializable {
    private static SalaryAdvancesController instance;
    @FXML
    ...
    public SalaryAdvancesController(Stage stage) {
        Platform.runLater(
                () -> {
                    try {
    ...
    public static SalaryAdvancesController getInstance(Stage stage) {
        if (instance == null) instance = new SalaryAdvancesController(stage);
        return instance;
    }
