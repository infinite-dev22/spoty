...
public class ExpenseCategoryPage extends OutlinePage {
    ...
    private MFXContextMenu showContextMenu(MFXTableRow<ExpenseCategory> obj) {
        ...
        edit.setOnAction(
                e -> {
                    ExpenseCategoryViewModel.getItem(obj.getData().getId(), () -> SpotyDialog.createDialog(new ExpenseCategoryForm(), this).showAndWait(), this::errorMessage);
                    e.consume();
                });
    ...
    public void createBtnAction() {
        createBtn.setOnAction(event -> SpotyDialog.createDialog(new ExpenseCategoryForm(), this).showAndWait());
    }
