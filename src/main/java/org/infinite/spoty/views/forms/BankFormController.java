...
public class BankFormController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Input bindings.
        bankName.textProperty().bindBidirectional(BranchViewModel.nameProperty());
        accountName.textProperty().bindBidirectional(BranchViewModel.emailProperty());
        accountNumber.textProperty().bindBidirectional(BranchViewModel.phoneProperty());
        branch.textProperty().bindBidirectional(BranchViewModel.townProperty());
        // Input listeners.
        requiredValidator(
