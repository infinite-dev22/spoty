...
public class ProductFormController implements Initializable {
  ...
  @FXML public MFXComboBox<ProductCategory> productFormCategory;
  @FXML public MFXComboBox<Brand> productFormBrand;
  @FXML public MFXComboBox<String> productFormBarCodeType;
  @FXML public MFXFilledButton productFormSaveBtn;
  @FXML public MFXOutlinedButton productFormCancelBtn;
  @FXML public Label productFormTitle;
  @FXML public MFXToggleButton notForSaleToggle;
  @FXML public MFXToggleButton activeToggle;

  @Override
  public void initialize(URL location, ResourceBundle resources) {
    productFormName
        .textProperty()
        .addListener((observable, oldValue, newValue) -> productFormName.setTrailingIcon(null));
    productFormCategory
        .textProperty()
        .addListener((observable, oldValue, newValue) -> productFormCategory.setLeadingIcon(null));
    productFormBrand
        .textProperty()
        .addListener((observable, oldValue, newValue) -> productFormBrand.setLeadingIcon(null));
    productFormBarCodeType
        .textProperty()
        .addListener(
            (observable, oldValue, newValue) -> productFormBarCodeType.setLeadingIcon(null));
    ...
    productFormBarCodeType
        .textProperty()
        .bindBidirectional(ProductMasterViewModel.barcodeTypeProperty());
    notForSaleToggle
        .selectedProperty()
  ...
  private void dialogOnActions() {
    productFormCancelBtn.setOnAction(
        (e) -> {
          closeDialog(e);
    ...
    productFormSaveBtn.setOnAction(
        (e) -> {
