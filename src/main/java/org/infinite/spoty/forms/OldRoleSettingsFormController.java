...
public class OldRoleSettingsFormController implements Initializable {
  private static OldRoleSettingsFormController instance;
  ...
  public OldRoleSettingsFormController() {
  ...
  public static OldRoleSettingsFormController getInstance() {
    if (Objects.equals(instance, null)) instance = new OldRoleSettingsFormController();
    return instance;
  }
