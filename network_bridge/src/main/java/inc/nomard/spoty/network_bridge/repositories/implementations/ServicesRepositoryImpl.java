...
public class ServicesRepositoryImpl extends ProtectedGlobals implements SimpleRepository {
    @Override
        ...
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.allServices))
    ...
    public Task<HttpResponse<String>> fetch(FindModel findModel) {
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.serviceById))
                        .header("Authorization", authToken)
                        .header("Accept", "application/json")
                        .header("Content-Type", "application/json")
    ...
    public Task<HttpResponse<String>> search(SearchModel searchModel) {
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.searchServices))
                        .header("Authorization", authToken)
                        .header("Accept", "application/json")
                        .header("Content-Type", "application/json")
    ...
    public Task<HttpResponse<String>> post(Object object) {
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.addService))
                        .header("Authorization", authToken)
                        .header("Accept", "application/json")
                        .header("Content-Type", "application/json")
    ...
    public Task<HttpResponse<String>> put(Object object) {
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.updateService))
                        .header("Authorization", authToken)
                        .header("Accept", "application/json")
                        .header("Content-Type", "application/json")
    ...
    public Task<HttpResponse<String>> delete(FindModel findModel) {
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.deleteService))
                        .header("Authorization", authToken)
                        .header("Accept", "application/json")
                        .header("Content-Type", "application/json")
    ...
    public Task<HttpResponse<String>> deleteMultiple(ArrayList<FindModel> findModelList) {
        return new Task<>() {
            ...
            private HttpResponse<String> taskCreate() throws IOException, InterruptedException {
                var request = HttpRequest.newBuilder()
                        .uri(URI.create(EndPoints.Services.deleteServices))
                        .header("Authorization", authToken)
                        .header("Accept", "application/json")
                        .header("Content-Type", "application/json")
